                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    <select name="status_approved" id="status_approved" class="form-select">
                                        ...
                                        <option value="p" {{ Request('status_approved') == 'p' ? 'selected' : '' }}>Pending</option>
                                        <option value="a" {{ Request('status_approved') == 'a' ? 'selected' : '' }}>Di Setujui</option>
                                        <option value="n" {{ Request('status_approved') == 'n' ? 'selected' : '' }}>Di Tolak</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-3">
                        ...
                        <tbody>
                            @foreach ($izinsakit as $d)
                                <tr>
                                    ...
                                    <td>{{ $d->keterangan }}</td>
                                    <td>
                                        @if ($d->status_approved == 'a')
                                            <span class="badge bg-success">Di Setujui</span>
                                        @elseif ($d->status_approved == 'n')
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Form Data Izin atau Sakit</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="/presensi/approveizinsakit" method="POST">
                        @csrf
                        <input type="hidden" id="izinsakit_form" name="izinsakit_form">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <select name="status_approved" id="status_approved" class="form-select">
                                        <option value="a">Di Setujui</option>
                                        <option value="n">Di Tolak</option>
                                    </select>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(function() {
            $("#approve").click(function(e) {
                ...
                $("#izinsakit_form").val(id_izinsakit);
