...
@section('content')
    <div class="row" style="margin-top:70px">
        <div class="col">
            <form method="POST" action="/presensi/storeizin" id="formizin" autocomplete="off">
                @csrf
                ...
                $.ajax({
                    ...
                    success: function(respond) {
                        if (respond == 1) {
                            Swal.fire({
                                title: 'Oops !',
                                text: 'Anda Sudah Mengajukan Izin Pada Tanggal Tersebut ! Silahkan Pilih Tanggal Yang Lain !',
                                icon: 'warning'
                            }).then((result) => {
                                $("#tgl_izin").val("");
                            });
