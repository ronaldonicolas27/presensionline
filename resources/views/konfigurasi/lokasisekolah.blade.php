                                    ...
                                    <div class="col-12">
                                        <div class="input-icon mb-3">
                                            ...
                                            <input type="text" value="{{ $lok_sekolah->lokasi_sekolah }}"
                                                class="form-control" name="lokasi_sekolah" id="lokasi_sekolah"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="input-icon mb-3">
                                            ...
                                            <input type="text" value="{{ $lok_sekolah->radius }}" class="form-control"
                                                name="radius" id="radius" placeholder="Radius Sekolah">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
