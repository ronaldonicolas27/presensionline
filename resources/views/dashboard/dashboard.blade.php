            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding:12px 12px !important; line-height:0.8rem">
                        <span class="badge bg-danger" style="position: absolute; top:3px; right:6px; font-size:0.7rem; z-index:999">
                        {{ $rekappresensi->jmlhadir }}
                        </span>
                        <ion-icon name="briefcase-outline" style="font-size: 1.6rem" class="text-success mb-1"></ion-icon><br>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding:12px 12px !important; line-height:0.8rem">
                        ...
                        <ion-icon name="airplane-outline" style="font-size: 1.6rem" class="text-primary mb-1"></ion-icon><br>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding:12px 12px !important; line-height:0.8rem">
                        ...
                        <ion-icon name="hourglass-outline" style="font-size: 1.6rem" class="text-danger mb-1"></ion-icon><br>
                        <span style="font-wight:500">Telat</span>
                    </div>
                </div>
            </div>
        </div>
